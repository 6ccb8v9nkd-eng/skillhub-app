...
function pendingManualForMentor(){
  ...
  return (S.manualAnswers||[]).filter(x=>x.status==='submitted'&&team.has(x.login)).slice().sort((a,b)=>new Date(b.updated_at||b.created_at)-new Date(a.updated_at||a.created_at));
}
