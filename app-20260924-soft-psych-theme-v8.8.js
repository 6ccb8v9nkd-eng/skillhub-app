...
function renderRgPractice(){
  ...
  page.innerHTML=`<div class="rg-demo-intro"><div><span class="rg-demo-kicker">ТОЛЬКО ДЛЯ РУКОВОДИТЕЛЯ ГРУППЫ</span><h2>Попробуйте весь цикл ручного тренажёра</h2><p>Это безопасное демо. Ответы хранятся только в вашем браузере и не попадают в статистику сотрудников.</p></div><button class="btn secondary" onclick="rgDemoReset()">Сбросить демо</button></div>
