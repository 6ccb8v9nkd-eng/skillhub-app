const CACHE='skillhub-7-4-4-avatar-fix-v1';
const SHELL=['./','./index.html','./styles.css?v=744','./app.js?v=744','./manifest.webmanifest?v=744','./icon-192-v718.png','./icon-512-v718.png'];
