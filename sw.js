const CACHE='skillhub-7-4-2-tech-admin-v1';
const SHELL=['./','./index.html','./styles.css?v=742','./app.js?v=742','./manifest.webmanifest?v=742','./icon-192-v718.png','./icon-512-v718.png'];
