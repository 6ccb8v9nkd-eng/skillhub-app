const CACHE='skillhub-7-3-0-visual-refresh-v1';
const SHELL=['./','./index.html','./styles.css?v=730','./app.js?v=730','./manifest.webmanifest?v=730','./icon-192-v718.png','./icon-512-v718.png'];
