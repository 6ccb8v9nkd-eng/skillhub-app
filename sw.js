const CACHE='skillhub-7-2-1-tech-admin-codes-v1';
const SHELL=['./','./index.html','./styles.css?v=720','./app.js?v=720','./manifest.webmanifest?v=720','./icon-192-v718.png','./icon-512-v718.png'];
