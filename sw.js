const CACHE='skillhub-7-1-6-role-labels-v1';
const SHELL=['./','./index.html','./styles.css','./app.js?v=716','./config.js?v=716','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
