const CACHE='skillhub-7-2-2-user-search-v1';
const SHELL=['./','./index.html','./styles.css?v=722','./app.js?v=722','./manifest.webmanifest?v=722','./icon-192-v718.png','./icon-512-v718.png'];
