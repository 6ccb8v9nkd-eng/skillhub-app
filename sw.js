const CACHE='skillhub-7-1-4-roles-no-code-v1';
const SHELL=['./','./index.html','./styles.css','./app.js?v=714','./config.js?v=714','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
