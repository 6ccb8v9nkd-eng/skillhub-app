const CACHE='skillhub-7-2-5-multi-assignment-v1';
const SHELL=['./','./index.html','./styles.css?v=725','./app.js?v=725','./manifest.webmanifest?v=725','./icon-192-v718.png','./icon-512-v718.png'];
