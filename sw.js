const CACHE='skillhub-7-4-3-reports-v1';
const SHELL=['./','./index.html','./styles.css?v=743','./app.js?v=743','./manifest.webmanifest?v=743','./icon-192-v718.png','./icon-512-v718.png'];
